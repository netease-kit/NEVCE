...
import com.netease.yunxin.app.finance.utils.ScreenUtils;
...
public class FaceView extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    private void initHolder(Context context) {
        ...
        mBgArcPaint.setColor(getResources().getColor(R.color.blue));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        LogUtils.d(TAG, "onMeasure  mViewWidth : " + mViewWidth + "  mViewHeight : " + mViewHeight);
    ...
    public void setProgress(float progress){
        ...
        currentAngle = (mEndAngle * progress) > mStartAngle ? (mEndAngle * progress) : mStartAngle;
    }
