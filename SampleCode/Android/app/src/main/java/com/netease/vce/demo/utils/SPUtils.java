...
import com.netease.vce.demo.VCEApplication;
...
public final class SPUtils {
    ...
    public static SPUtils getInstance() {
        return getInstance(SP_FILE, Context.MODE_PRIVATE);
    }
    ...
    public static SPUtils getInstance(final int mode) {
        return getInstance(SP_FILE, mode);
    }
    ...
    private SPUtils(final String spName) {
        sp = VCEApplication.getInstance().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }

    private SPUtils(final String spName, final int mode) {
        sp = VCEApplication.getInstance().getSharedPreferences(spName, mode);
    }
